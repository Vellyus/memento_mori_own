...
var gender = "male";//prompt("Are you a male or a female? (format: male / female)");
var year = 1994;//parseInt(prompt("Which year were you born? (format: 1994)"));
var month = 02;//parseInt(prompt("Which month were you born? (format: 02 / 2)"));
var day = 26;//parseInt(prompt("Which day were you born? (format: 02 / 2)"));
